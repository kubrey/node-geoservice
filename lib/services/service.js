...
var debug = require('debug')(conf.getVal('projectName') + ":service");
...
BaseService.prototype.loadConfigs = function () {
    ...
    this.config = conf.getVal('services:' + this.method);
};
...
BaseService.prototype.lookup = function (ip, callback) {
    ...
    var self = this;
    var ipv6Enabled = conf.getVal('services:' + self.method + ":v6");
    ...
    req.setTimeout(parseInt(conf.getVal('commonOptions:timeout')), function () {
        req.abort();
